  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 bg-background">
      <div className="text-center max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-6">Welcome to Shipment Management</h1>
        <p className="text-xl mb-8">
          Efficiently track and manage your shipments with real-time updates and detailed insights.
        </p>
